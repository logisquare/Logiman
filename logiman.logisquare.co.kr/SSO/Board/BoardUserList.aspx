<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoardUserList.aspx.cs" Inherits="SSO.Board.BoardUserList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/SSO/Board/Proc/BoardUserList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
