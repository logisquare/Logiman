// 그리드
var GridID = "#SecurityFieldListGrid";
var GridSort = [];
...
function fnGridInit() {
    // 그리드 레이아웃 생성
    fnCreateGridLayout(GridID, "FieldName");
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, "SecurityFieldListGrid");
        return;
    });
};
        ...
        },
        {
            ...
            renderer: {
                ...
                onClick: function (event) {
                    fnInsSecurityField("필드 수정", event.item.FieldName);
                }
            }
        }
    ];
...
function fnGridCellDblClick(event) {
    ...
    fnInsSecurityField("필드 수정", objItem.FieldName);
}
