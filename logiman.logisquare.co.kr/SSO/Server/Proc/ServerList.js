...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, "ServerListGrid");
        return;
    });
};
...
function fnGetDefaultColumnLayout() {
    var objColumnLayout = [
        ...
        {
            dataField: "ServerIPAddr1",
            headerText: "서버 아이피 주소1",
            editable: false,
            width: 150,
            viewstatus: true
        },
        {
            dataField: "ServerIPAddr2",
            headerText: "서버 아이피 주소2",
            editable: false,
            width: 150,
            viewstatus: true
        },
        {
            dataField: "ServerStateCodeM",
            headerText: "서버 상태",
            editable: false,
            width: 150,
            viewstatus: true
