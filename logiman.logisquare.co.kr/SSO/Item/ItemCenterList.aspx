<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemCenterList.aspx.cs" Inherits="SSO.Item.ItemCenterList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/SSO/Item/Proc/ItemCenterList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
