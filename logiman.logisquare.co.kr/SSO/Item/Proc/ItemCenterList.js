...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/SSO/Item/Proc/ItemCenterHandler.ashx";
...
function fnGetCenterListDefaultColumnLayout() {
    var objColumnLayout = [
        ...
        {
            dataField: "OrgUseFlag",
            headerText: "OrgUseFlag",
            editable: false,
            visible: false,
            width: 0,
            viewstatus: false
