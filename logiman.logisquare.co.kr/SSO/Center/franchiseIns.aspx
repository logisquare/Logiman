<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="FranchiseIns.aspx.cs" Inherits="SSO.Center.FranchiseIns" %>
<%@ Import Namespace="CommonLibrary.CommonModule" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="./Proc/FranchiseIns.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="iframe_wrap">
        <div runat="server" id="POPUP_VIEW">
            <div class="popup_control">
                <table id="maintable" class="popup_table" style="display:none; border-top:0px;">
                    ...
                    <tr>
                        ...
                        <td class="lft"><asp:DropDownList runat="server" ID="CenterType" onchange="fnChangeCenterType();" CssClass="type_01 essential"></asp:DropDownList></td>
            ...
            <div style="text-align:center;margin-top:10px" runat="server" id="InsRegBtn">
