<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CenterList.aspx.cs" Inherits="CENTER.Center.CenterList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/SSO/Center/Proc/CenterList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if ($("#GradeCode").val() === "1" || $("#GradeCode").val() === "2" || $("#GradeCode").val() === "3") {
                $("#BtnCenterIns").css("display", "");
            }
        });
        ...
        function fnInsCenter(strTitle, strCenterCode) {
            fnOpenRightSubLayer(strTitle, "/SSO/Center/CenterIns.aspx?CenterCode=" + strCenterCode, "1024px", "700px", "80%");
        }

        function fnHomeTaxDeptUserIns(strTitle, strCenterCode) {
            fnOpenRightSubLayer(strTitle, "/SSO/Center/CenterHomeTaxDeptUserIns?CenterCode=" + strCenterCode, "1024px", "700px", "30%");
        }
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contents">
        <div class="data_list">
            ...
            <ul class="action">
                <li class="left">
                    <button type="button" class="btn_02" id="BtnCenterIns" style="display:none;" onclick="javascript:fnInsCenter('회원사 추가', '');">회원사 추가</button>
                </li>
                <li class="right"></li>
            </ul>
        </div>
