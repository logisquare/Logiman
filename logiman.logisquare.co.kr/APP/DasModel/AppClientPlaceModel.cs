...
{
    public class AppClientPlaceChargeViewModel 
    {
    ...
    public class ReqAppClientPlaceChargeList
    {
        public long     PlaceSeqNo          { get; set; }
    ...
    public class ResAppClientPlaceChargeList
    {
        public List<AppClientPlaceChargeListViewModel> list { get; set; }
        public int RecordCnt { get; set; }
    }

    public class AppClientPlaceChargeListViewModel
    {   
        //상하차지 담당자
        public int SeqNo                    { get; set; }
    ...
    public class AppClientPlaceSearchModel
    {
        public int    PlaceSeqNo       { get; set; }
        public int    CenterCode       { get; set; }
    ...
    public class ReqAppClientPlaceSearchList
    {
        public int    CenterCode       { get; set; }
        public string PlaceName        { get; set; }
        public string UseFlag          { get; set; }
    ...
    public class ResAppClientPlaceSearchList
    {
        public List<AppClientPlaceSearchModel> list      { get; set; }
        public int                          RecordCnt { get; set; }
    }


    public class AppClientPlaceChargeSearchModel
    {
        public int    PlaceSeqNo       { get; set; }
        public int    CenterCode       { get; set; }
        public string CenterName       { get; set; }
    ...
    public class ReqAppClientPlaceChargeSearchList
    {
        public int    CenterCode       { get; set; }
        public long   PlaceSeqNo       { get; set; }
        public string PlaceName        { get; set; }
    ...
    public class ResAppClientPlaceChargeSearchList
    {
        public List<AppClientPlaceChargeSearchModel> list { get; set; }
        public int RecordCnt { get; set; }
    }


    public class ReqAppClientPlaceNote
    {
        public int    CenterCode   { get; set; }
        public string PlaceName    { get; set; }
        public string PlaceAddr    { get; set; }
    ...
    public class ResAppClientPlaceNote
    {
    ...
    public class ReqAppClientPlaceNoteUpd
    {
        public int    CenterCode   { get; set; }
