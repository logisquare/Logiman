...
{
    public class AppConsignorModel
    {
    ...
    public class ReqAppConsignorList
    {
        public int    ConsignorCode    { get; set; }
        public int    CenterCode       { get; set; }
        public string CenterName       { get; set; }
    ...
    public class ResAppConsignorList
    {
        public List<AppConsignorModel> list      { get; set; }
        public int                  RecordCnt { get; set; }
    }

    public class AppConsignorSearchModel
    {
        public int    ConsignorCode { get; set; }
        public int    CenterCode    { get; set; }
        public string CenterName    { get; set; }
    ...
    public class ReqAppConsignorSearchList
    {
        public int    CenterCode       { get; set; }
    ...
    public class ResAppConsignorSearchList
    {
        public List<AppConsignorSearchModel> list      { get; set; }
        public int                        RecordCnt { get; set; }
    }

    public class AppConsignorMapSearchModel
    {
    ...
    public class ReqAppConsignorMapSearchList
    {
        public int    CenterCode       { get; set; }
        public string ConsignorName    { get; set; }
        public string UseFlag          { get; set; }
    ...
    public class ResAppConsignorMapSearchList
    {
        public List<AppConsignorMapSearchModel> list      { get; set; }
        public int                        RecordCnt { get; set; }
    }

    public class AppConsignorGMModel
    {
    ...
    public class AppConsignorGMGridModel
    {
    ...
    public class ReqAppConsignorGMList
    {
        public long   GMSeqNo          { get; set; }
        public int    CenterCode       { get; set; }
        public string ConsignorName    { get; set; }
    ...
    public class ResAppConsignorGMList
    {
        public List<AppConsignorGMGridModel> list      { get; set; }
        public int                        RecordCnt { get; set; }
    }
}