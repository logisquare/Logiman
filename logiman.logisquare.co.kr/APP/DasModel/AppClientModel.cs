...
namespace CommonLibrary.DasServices
{
    ...
    public class ResAppClientList
    {
        public List<AppClientModel> list      { get; set; }
        public int                  RecordCnt { get; set; }
    }


    public class AppClientChargeModel
    {
    ...
    public class ReqAppClientChargeList
    {
        public int    ChargeSeqNo      { get; set; }
        public int    ClientCode       { get; set; }
        public int    CenterCode       { get; set; }
    ...
    public class ResAppClientChargeList
    {
        public List<AppClientChargeModel> list      { get; set; }
        public int                     RecordCnt { get; set; }
    }

    public class AppClientConsignorModel
    {
    ...
    public class ReqAppClientConsignorList
    {
        public int    SeqNo            { get; set; }
        public int    CenterCode       { get; set; }
        public int    ClientCode       { get; set; }
    ...
    public class ResAppClientConsignorList
    {
        public List<AppClientConsignorModel> list      { get; set; }
        public int                        RecordCnt { get; set; }
    }


    public class AppClientSearchModel
    {
    ...
    public class ReqAppClientSearchList
    {
        public int    ClientCode        { get; set; }
        public int    CenterCode        { get; set; }
        public string ClientType        { get; set; }
    ...
    public class ResAppClientSearchList
    {
        public List<AppClientSearchModel> list      { get; set; }
        public int                     RecordCnt { get; set; }
    }

    public class ReqAppClientNoteUpd
    {
        public int    CenterCode    { get; set; }
