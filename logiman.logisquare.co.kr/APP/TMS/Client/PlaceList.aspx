<%@ Page Language="C#" MasterPageFile="~/APP/MasterPage/AppSite.Master" AutoEventWireup="true" CodeBehind="PlaceList.aspx.cs" Inherits="APP.TMS.Client.PlaceList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/APP/TMS/Client/Proc/PlaceList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <script>
...
<asp:Content ID="Header" ContentPlaceHolderID="HeaderContent" runat="server">
    <div class="header">
        <h1>상하차지 관리</h1>
        <button type="button" onclick="fnDataIns();">상하차지등록</button>
    </div>
</asp:Content>
    ...
    <div id="DataList">
        ...
        <div class="search_body">
            <div class="search_area">
                ...
                <ul class="ul_type_01">
                    <li>
                        <asp:TextBox runat="server" ID="PlaceName" class="type_01" AutoPostBack="false" placeholder="상하차지 검색"/>
                    </li>
                </ul>
                <ul class="ul_type_01">
                    <li>
        ...
        <div class="list_area">
            ...
            <ul class="car_list" id="PlaceData">
            </ul>
            <div class="more_list">
