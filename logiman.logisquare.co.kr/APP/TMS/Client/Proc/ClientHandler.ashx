...
/// Description     : APP 고객사 Process Handler
/// Special Logic
...
/// </summary>
///================================================================
public class ClientHandler : AppAshxBaseHandler
{
    // 메소드 리스트
    ...
    AppClientDasServices    objAppClientDasServices        = new AppClientDasServices();
    ...
    {
        ReqAppClientList                lo_objReqClientList = null;
        ServiceResult<ResAppClientList> lo_objResClientList = null;

        try
        {
            lo_objReqClientList = new ReqAppClientList
            {
            ...
            lo_objResClientList   = objAppClientDasServices.GetClientList(lo_objReqClientList);
