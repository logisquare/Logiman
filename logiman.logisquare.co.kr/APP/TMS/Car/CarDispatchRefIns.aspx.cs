...
{
    public partial class CarDispatchRefIns : AppPageBase
    {
        ...
        protected void GetCarDispatchDetail()
        {
            ...
            try
            {
                ...
                UseFlag.Value            = lo_objResCarDispatchList.data.list[0].RefUseFlag;
                ...
                DivAgreement.Visible      = lo_objResCarDispatchList.data.list[0].CenterContractFlag.Equals("Y");
