<%@ WebHandler Language="C#" Class="AppCarDispatchRefHandler" %>
...
///================================================================
/// <summary>
/// FileName        : AppCarDispatchRefHandler.ashx
/// Description     : APP 차량관리 Process Handler
/// Special Logic
...
/// </summary>
///================================================================
public class AppCarDispatchRefHandler : AppAshxBaseHandler
{

    // 메소드 리스트
    private const string   MethodCarDispatchList    = "CarDispatchList";           //차량업체 조회
    private const string   MethodChkCarNo           = "ChkCarNo";                  //사업자 조회
    ...
    private const string   MethodCarDispatchIns     = "CarDispatchInsert";          //차량등록

    AppCarDispatchDasServices objAppCarDispatchDasServices = new AppCarDispatchDasServices();
    ...
    private string strPayDay           = string.Empty;
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("AppCarDispatchRefHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("AppCarDispatchRefHandler");
        }
    }
    ...
    private void GetData()
    {
        try
        {
            ...
            strPayDay           = Utils.IsNull(SiteGlobal.GetRequestForm("PayDay"),         "0");
            strBankCode         = Utils.IsNull(SiteGlobal.GetRequestForm("BankCode"),       "");
            strEncAcctNo        = Utils.IsNull(SiteGlobal.GetRequestForm("EncAcctNo"),      "");
    ...
    {
        ReqAppCarDispatchList                lo_objReqCarDispatchList = null;
        ServiceResult<ResAppCarDispatchList> lo_objResCarDispatchList = null;

        try
        {
            lo_objReqCarDispatchList = new ReqAppCarDispatchList
            {
            ...
            lo_objResCarDispatchList    = objAppCarDispatchDasServices.GetCarDispatchList(lo_objReqCarDispatchList);
    ...
    protected void GetChkCorpNo() 
    {
        ...
        try
        {
            ...
            if (lo_objResCarDispatchList.data.RecordCnt > 0)
            {
                ...
                GetCarCompanyDtl(lo_intComCode, intCenterCode);
            }
            else 
            {
    ...
    /// 업체 상세정보 
    /// </summary>
    protected void GetCarCompanyDtl(Int64 lo_intComCode, int lo_intCenterCode) {
        ReqCarDispatchList                lo_objReqCarDispatchList = null;
        ServiceResult<ResCarDispatchList> lo_objResCarDispatchList = null;;
        ...
        if (string.IsNullOrWhiteSpace(lo_intCenterCode.ToString()))
        {
    ...
    protected void GetCarDispatchRefIns()
    {
        ...
        if (string.IsNullOrWhiteSpace(intCenterCode.ToString()))
        {
            objResMap.RetCode = 9001;
        ...
        if (string.IsNullOrWhiteSpace(intCarDivType.ToString()))
        {
            objResMap.RetCode = 9001;
        ...
        try
        {
            ...
            { 
                objResMap.Add("RefSeqNo", lo_objResInsCarDispatch.data.RefSeqNo);    
            }
        }
        catch (Exception lo_ex)
        {
            objResMap.RetCode = 9420;
            objResMap.ErrMsg  = CommonConstant.COMMON_EXCEPTION_MESSAGE;
