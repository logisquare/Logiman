...
{
    public partial class InoutList : AppPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HidLocationCode.Value = Utils.IsNull(SiteGlobal.GetRequestForm("OrderLocationCodes"), "");
            HidOrderItemCode.Value = Utils.IsNull(SiteGlobal.GetRequestForm("OrderItemCodes"), "");
