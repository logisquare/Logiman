...
/// Description     : APP 내수오더 Process Handler
/// Special Logic
...
/// </summary>
///================================================================
public class DomesticHandler : AppAshxBaseHandler
{
    //상수 선언
    ...
    private const string MethodDomesticDispatchCarUpd  = "DomesticDispatchCarUpdate"; //배차차량 목록
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        objMethodAuthList.Add(MethodDomesticDispatchCarUpd,       MenuAuthType.ReadWrite);        
        ...
        */
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("AppDomesticHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("AppDomesticHandler");
        }
    }
        ...
        try
        {
            switch (strCallType)
            {
                ...
                case MethodDomesticDispatchCarList:
                    ...
                    break;
                case MethodDomesticDispatchCarUpd:
                    SetDomesticDispatchCarUpd();
                    break;
    ...
    /// 내수 배차 변경
    /// </summary>
    protected void SetDomesticDispatchCarUpd()
    {
        ReqAppOrderDispatchUpd lo_objReqAppOrderDispatchUpd = null;
        ServiceResult<bool>    lo_objResAppOrderDispatchUpd = null;
        int                    lo_intDispatchType           = 1;
        int                    lo_intDispatchKind           = 1;
        ...
        try
        {
            lo_objReqAppOrderDispatchUpd = new ReqAppOrderDispatchUpd
            {
                CenterCode       = strCenterCode.ToInt(),
                OrderNo          = strOrderNo.ToInt64(),
                QuickType        = strQuickType.ToInt(),
                DispatchType     = lo_intDispatchType,
                DispatchKind     = lo_intDispatchKind,
                RefSeqNo         = strRefSeqNo.ToInt64(),
                InsureExceptKind = strInsureExceptKind.ToInt(),
                UpdAdminID       = objSes.AdminID,
                UpdAdminName     = objSes.AdminName
            ...
            lo_objResAppOrderDispatchUpd = objAppOrderDasServices.SetAppOrderDispatchUpd(lo_objReqAppOrderDispatchUpd);
            objResMap.RetCode            = lo_objResAppOrderDispatchUpd.result.ErrorCode;

            if (objResMap.RetCode.IsFail())
            {
                objResMap.ErrMsg = lo_objResAppOrderDispatchUpd.result.ErrorMsg;
            }
        }
        catch (Exception lo_ex)
        {
    ...
    {
        ReqAppTransRateOrderList                lo_objReqAppTransRateOrderList = null;
        ServiceResult<ResAppTransRateOrderList> lo_objResAppTransRateOrderList = null;
        ...
        try
        {
            lo_objReqAppTransRateOrderList = new ReqAppTransRateOrderList
            {
                CenterCode        = strCenterCode.ToInt(),
                OrderNo           = strOrderNo.ToInt64(),
            ...
            lo_objResAppTransRateOrderList = objAppOrderDasServices.GetAppTransRateOrderList(lo_objReqAppTransRateOrderList);
                
            objResMap.strResponse = "[" + JsonConvert.SerializeObject(lo_objResAppTransRateOrderList) + "]";
        }
        catch (Exception lo_ex)
        {
    ...
    {
        ReqAppTransRateOrderApplyList                lo_objReqAppTransRateOrderApplyList = null;
        ServiceResult<ResAppTransRateOrderApplyList> lo_objResAppTransRateOrderApplyList = null;
        ...
        try
        {
            ...
            lo_objReqAppTransRateOrderApplyList = new ReqAppTransRateOrderApplyList
            {
                CenterCode        = strCenterCode.ToInt(),
            ...
            lo_objResAppTransRateOrderApplyList = objAppOrderDasServices.GetAppTransRateOrderApplyList(lo_objReqAppTransRateOrderApplyList);
                
            objResMap.strResponse = "[" + JsonConvert.SerializeObject(lo_objResAppTransRateOrderApplyList) + "]";
        }
        catch (Exception lo_ex)
        {
            objResMap.RetCode = 9406;
