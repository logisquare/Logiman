<%@ Page Language="C#" MasterPageFile="~/APP/MasterPage/AppSite.Master" AutoEventWireup="true" CodeBehind="DomesticList.aspx.cs" Inherits="APP.TMS.Domestic.DomesticList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script type="text/javascript" src="/APP/TMS/Domestic/Proc/DomesticList.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
