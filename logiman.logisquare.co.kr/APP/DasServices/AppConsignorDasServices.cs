...
{
    public class AppConsignorDasServices
    {
        ...
        /// <returns></returns>
        public ServiceResult<ResAppConsignorList> GetAppConsignorList(ReqAppConsignorList objReqConsignorList)
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorList REQ] {JsonConvert.SerializeObject(objReqConsignorList)}", bLogWrite);
            
            string                          lo_strJson   = string.Empty;
            ServiceResult<ResAppConsignorList> lo_objResult = null;
            IDasNetCom                      lo_objDas    = null;

            try
            {
                lo_objResult = new ServiceResult<ResAppConsignorList>(CommonConstant.DAS_RET_VAL_CODE);
                ...
                lo_objDas.SetQuery("dbo.UP_APP_CONSIGNOR_AR_LST");
                ...
                lo_objResult.data = new ResAppConsignorList
                {
                    list      = new List<AppConsignorModel>(),
                ...
                if (lo_objDas.RecordCount > 0)
                {
                    ...
                    lo_objResult.data.list = JsonConvert.DeserializeObject<List<AppConsignorModel>>(lo_strJson);
                }
            }
            catch (Exception ex)
            {
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorList RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorIns REQ] {JsonConvert.SerializeObject(objConsignorModel)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorIns RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorUpd REQ] {JsonConvert.SerializeObject(objConsignorModel)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorUpd RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorSearchList REQ] {JsonConvert.SerializeObject(objReqConsignorSearchList)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorSearchList RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorMapSearchList REQ] {JsonConvert.SerializeObject(objReqConsignorMapSearchList)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorMapSearchList RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorGMList REQ] {JsonConvert.SerializeObject(objReqConsignorGMList)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[GetConsignorGMList RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorGMIns REQ] {JsonConvert.SerializeObject(objConsignorGMModel)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorGMIns RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorGMUpd REQ] {JsonConvert.SerializeObject(objConsignorGMModel)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorGMUpd RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
        ...
        {
            SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorGMDel REQ] {JsonConvert.SerializeObject(objConsignorGMModel)}", bLogWrite);
            ...
            finally
            {
                ...
                SiteGlobal.WriteInformation("AppConsignorDasServices", "I", $"[SetConsignorGMDel RES] {JsonConvert.SerializeObject(lo_objResult)}", bLogWrite);
            }
