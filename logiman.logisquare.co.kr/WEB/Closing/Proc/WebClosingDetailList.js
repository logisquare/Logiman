// 그리드
var GridID = "#WebClosingDetailListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'WebClosingDetailListGrid');
        return;
    });
};
...
function fnCallGridData(strGID) {
    ...
    if (!$("#HidCenterCode").val() || !$("#HidSaleClosingSeqNo").val()) {
        return false;
    }
