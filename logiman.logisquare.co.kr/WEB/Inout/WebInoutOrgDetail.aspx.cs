...
namespace WEB.Inout
{
    public partial class WebInoutOrgDetail : PageBase
    {
        ...
        protected void GetOrderRequestDetail(string lo_strReqSeqNo, string lo_strOrderNo)
        {
            ...
            try
            {
                ...
                ReqChargeTel.Text  = lo_objWebResOrderList.data.list[0].ReqChargeTel;
                ReqChargeCell.Text = lo_objWebResOrderList.data.list[0].ReqChargeCell;
                ...
                OrderItemCodeM.Text = lo_objWebResOrderList.data.list[0].OrderItemCodeM;
                Nation.Text = lo_objWebResOrderList.data.list[0].Nation;
                Hawb.Text = lo_objWebResOrderList.data.list[0].Hawb;
                Mawb.Text = lo_objWebResOrderList.data.list[0].Mawb;
                InvoiceNo.Text = lo_objWebResOrderList.data.list[0].InvoiceNo;
                BookingNo.Text = lo_objWebResOrderList.data.list[0].BookingNo;
                StockNo.Text = lo_objWebResOrderList.data.list[0].StockNo;
                ArrivalReportFlag.Text = lo_objWebResOrderList.data.list[0].ArrivalReportFlag;
                BondedFlag.Text = lo_objWebResOrderList.data.list[0].BondedFlag;
                Volume.Text = lo_objWebResOrderList.data.list[0].Volume.ToString();
                CBM.Text = lo_objWebResOrderList.data.list[0].CBM.ToString();
                Weight.Text = lo_objWebResOrderList.data.list[0].Weight.ToString();
                Quantity.Text = lo_objWebResOrderList.data.list[0].Quantity.ToString();
            ...
            {
                SiteGlobal.WriteLog("WebInoutOrgDetail", "Exception",
