<%@ WebHandler Language="C#" Class="WebInoutFileHandler" %>
...
///================================================================
/// <summary>
/// FileName        : WebInoutFileHandler.ashx
...
/// </summary>
///================================================================
public class WebInoutFileHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/WEB/Inout/WebInoutIns"; //필수
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("WebInoutFileHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("WebInoutFileHandler");
        }
    }
