<%@ WebHandler Language="C#" Class="WebWebDomesticFileHandler" %>
...
///================================================================
/// <summary>
/// FileName        : WebWebDomesticFileHandler.ashx
/// Description     : 내수 오더 파일 Process Handler
/// Special Logic
///   - Use Session Variables : NONE
///   - Use Server Component  : NONE
///
/// Copyright ⓒ 2018 by LOGISLAB Inc. All rights reserved.
/// Author          : jylee88@logislab.com, 2022-09-20
/// Modify History  : Just Created.
/// </summary>
///================================================================
public class WebWebDomesticFileHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/WEB/Domestic/WebDomesticIns"; //필수
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("WebDomesticFileHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("WebDomesticFileHandler");
        }
    }
    ...
    private void SetFileUpload()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                lo_strFileDir      = SiteGlobal.FILE_SERVER_ROOT + @"\WEBORDER\Temp\";
                ...
                if (!lo_strExtension.Equals("jpg") &&
                    ...
                    !lo_strExtension.Equals("zip") &&
                    !lo_strExtension.Equals("tif"))
                {
    ...
    private void SetInsFileUpload()
    {
        ...
        {
            //업로드 파일 확인
            lo_strTempFileDir = SiteGlobal.FILE_SERVER_ROOT + @"\WEBORDER\Temp\";
            ...
            //디렉터리 생성
            lo_strNewFileDir   = SiteGlobal.FILE_SERVER_ROOT + @"\WEBORDER\" + strCenterCode + @"\" + strOrderNo.Substring(0, 6) + @"\" + strOrderNo.Substring(6, 2) + @"\" + strOrderNo + @"\";
            lo_strNewDBFileDir = "/WEBORDER/" + strCenterCode + "/" + strOrderNo.Substring(0, 6) + "/" + strOrderNo.Substring(6, 2) + "/" + strOrderNo;
    ...
    private void SetFileDownload()
    {
        ...
        try
        {
            ...
            {
                lo_strFileDir = SiteGlobal.FILE_SERVER_ROOT + @"\WEBORDER\" + strCenterCode + @"\" + strOrderNo.Substring(0,6) + @"\" + strOrderNo.Substring(6, 2) + @"\" + strOrderNo + @"\";
            }
            else
            {
                lo_strFileDir = SiteGlobal.FILE_SERVER_ROOT + @"\WEBORDER\Temp\";
