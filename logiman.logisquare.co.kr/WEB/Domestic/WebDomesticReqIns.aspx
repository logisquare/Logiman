<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="WebDomesticReqIns.aspx.cs" Inherits="WEB.Domestic.WebDomesticReqIns" %>
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script type="text/javascript" src="/WEB/Domestic/Proc/WebDomesticReqIns.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <script>
            ...
            <div class="popup_control">
                ...
                <div>
                    <div style="margin-top:20px;">
                        <div id="WebDomesticReqInsGrid"></div>
                        <div id="page"></div>
                    </div>
                </div>
            </div>
