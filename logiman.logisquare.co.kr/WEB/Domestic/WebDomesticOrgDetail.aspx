<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="WebDomesticOrgDetail.aspx.cs" Inherits="WEB.Domestic.WebDomesticOrgDetail" %>
                    ...
                    <div class="search">
                        ...
                        <table class="popup_table">
                            ...
                            <tr>
                                ...
                                <td class="change_td">
                                    <strong>요청톤급</strong>
                                    <asp:Label runat="server" ID="CarTonCodeM"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <strong>요청차종</strong>
                                    <asp:Label runat="server" ID="CarTypeCodeM"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <strong>품목</strong>
                                    <asp:Label runat="server" ID="GoodsItemCodeM"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <strong>운행구분</strong>
                                    <asp:Label runat="server" ID="GoodsRunTypeM"></asp:Label>
                                    <br />
                                    <strong>총중량</strong>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <strong>길이</strong>
                                    <asp:Label runat="server" ID="Length"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <strong>화물명</strong>
                                    <asp:Label runat="server" ID="GoodsName"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <strong>화물비고</strong>
                                    <asp:Label runat="server" ID="GoodsNote"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <th>기타정보</th>
