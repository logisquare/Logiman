// 그리드
var GridID = "#WebConsignorListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'WebConsignorListGrid');
        return;
    });
};
...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/WEB/Manage/Proc/WebConsignorHandler.ashx";
    var strCallBackFunc = "fnGridSuccResult";

    var objParam = {
        CallType: "WebConsignorList",
        UseFlag: $("#UseFlag").val(),
