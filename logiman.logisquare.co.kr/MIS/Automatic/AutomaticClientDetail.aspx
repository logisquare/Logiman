<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="AutomaticClientDetail.aspx.cs" Inherits="MIS.Automatic.AutomaticClientDetail" %>
...
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    ...
    <script src="/MIS/Automatic/Proc/AutomaticClientDetail.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#BtnSaveExcel").on("click", function () {
                var dtNow = new Date();
                var fileName = "자동운임_고객사별상세_" + dtNow.getHours() + dtNow.getMinutes() + dtNow.getSeconds();
                fnGridExportAs('#ClientChartDetailGrid', 'xlsx', fileName, fileName);
            });
        });
    </script>
</asp:Content>
    ...
    <div id="iframe_wrap">
        <div id="POPUP_VIEW">
            <div class="popup_control" style="padding:10px; border-radius:10px;">
                <h1 class="dash_title_02" style="display: inline-block; margin-right: 10px;" id="ClientName" runat="server"></h1>
                ...
                <div class="char_area">
                    <h1>적용률 현황</h1>
                    <div class="char_list">
                        <div id="ClientDeatilChart" style="width: 100%; height:370px;"></div>
                    </div>
                </div>
            </div>
        </div>
