...
function fnCreateGridLayout(strGID) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'AutomaticListGrid');
        return;
    });
};
...
function fnGetDefaultColumnLayout() {
    var objColumnLayout = [
        ...
        {
            dataField: "AppliedOrderCnt",
            headerText: "자동운임 적용건수",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "UnappliedOrderCnt",
            headerText: "자동운임 미적용건수",
            editable: false,
            width: 150,
            dataType: "numeric",
            viewstatus: true,
        ...
        {
            dataField: "AppliedSaleSupplyAmt",
            headerText: "자동운임 적용매출",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "AppliedPurchaseSupplyAmt",
            headerText: "자동운임 적용매입",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "AppliedProfitSupplyAmt",
            headerText: "자동운임 적용이익",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "AppliedProfitRate",
            headerText: "자동운임 적용이익률",
            editable: false,
            width: 150,
            viewstatus: true,
            dataType: "numeric",
        ...
        {
            dataField: "UnappliedSaleSupplyAmt",
            headerText: "자동운임 미적용매출",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "UnappliedPurchaseSupplyAmt",
            headerText: "자동운임 미적용매입",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "UnappliedProfitSupplyAmt",
            headerText: "자동운임 미적용이익",
            editable: false,
            width: 150,
            dataType: "numeric",
            style: "aui-grid-text-right",
        ...
        {
            dataField: "UnappliedProfitRate",
            headerText: "자동운임 미적용이익률",
            editable: false,
            width: 150,
            viewstatus: true,
            dataType: "numeric",
...
function fnGridSuccResult(objRes) {
    ...
    if (objRes) {
        ...
        AUIGrid.setGridData(GridID, objRes[0].data.Detaillist);
...
function fnSetGridFooter(strGID) {
    ...
    var GridFooterObject = [
        ...
        {
            positionField: "UnappliedOrderCnt",
            dataField: "UnappliedOrderCnt",
            operation: "SUM",
            formatString: "#,##0.##",
            style: "aui-grid-text-right"
        ...
        {
            positionField: "AppliedSaleSupplyAmt",
            dataField: "AppliedSaleSupplyAmt",
            operation: "SUM",
            formatString: "#,##0",
            postfix: "원",
        ...
        {
            positionField: "AppliedPurchaseSupplyAmt",
            dataField: "AppliedPurchaseSupplyAmt",
            operation: "SUM",
            formatString: "#,##0",
            postfix: "원",
        ...
        {
            positionField: "AppliedProfitSupplyAmt",
            dataField: "AppliedProfitSupplyAmt",
            operation: "SUM",
            formatString: "#,##0",
            postfix: "원",
        ...
        {
            positionField: "UnappliedSaleSupplyAmt",
            dataField: "UnappliedSaleSupplyAmt",
            operation: "SUM",
            formatString: "#,##0",
            postfix: "원",
        ...
        {
            positionField: "UnappliedPurchaseSupplyAmt",
            dataField: "UnappliedPurchaseSupplyAmt",
            operation: "SUM",
            formatString: "#,##0",
            postfix: "원",
        ...
        {
            positionField: "UnappliedProfitSupplyAmt",
            dataField: "UnappliedProfitSupplyAmt",
            operation: "SUM",
            formatString: "#,##0",
            postfix: "원",
