...
function fnSetGridDataSetting() {
    AUIGrid.setGridData("#AgentChartDetailGrid", []);
    ...
    fnCallGridData("#AgentChartDetailGrid");
}
...
//==========================================
// 그리드
var GridID = "#AgentChartDetailGrid";
...
function fnDrawCharts() {
    fnDrawChart("", "bar", chartDataJson.ChartItems, "건수", "OrderCount", "#AgentDeatilChart", 1, 20, "M");
}
...
function fnDrawChart(chartName, chartType, jsonItems, chartYAxisLabel, chartXAxisKey, chartTargetDivId, tickValueScale, barMaxWidth, dateType) {
    ...
    $.each(jsonItems, function (intIndex, objItem) {
        ...
        var UnAOrderSum = 0;
        //타이틀
        xTitle[intIndex + 1] = objItem.ItemNewData.ItemName.replace(/<br>/gi, "\n");
        //전체건수
