<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="AgentChartDetail.aspx.cs" Inherits="MIS.AgentChartDetail" %>
...
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    ...
    <script src="/MIS/Proc/AgentChartDetail.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField runat="server" ID="AgentName" />
    ...
    <div id="iframe_wrap">
        <div id="POPUP_VIEW">
            <div class="popup_control" style="background:#e7eaf0; padding:10px; border-radius:10px;">
                <h1 class="dash_title_02" id="disAgentName" runat="server"></h1>
                <div class="data_list">
                    <div class="search">
