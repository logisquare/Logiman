<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CarPossessClient.aspx.cs" Inherits="MIS.ExclusiveCar.CarPossessClient" %>
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    ...
    <script src="/MIS/ExclusiveCar/Proc/CarPossessClient.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    ...
    <div id="contents">
        <div class="data_list">
            <div class="search">
                ...
                <asp:DropDownList runat="server" ID="SearchType" class="type_01"></asp:DropDownList>
                <asp:TextBox runat="server" ID="SearchText" class="type_01" AutoPostBack="false" placeholder="업체명"/>
                <button type="button" runat="server" ID="BtnListSearch" onclick="fnSearchData();" class="btn_01">조회</button>

                &nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" onclick="fnGridExportAs(GridID, 'xlsx', '담당자별 전담율', '담당자별 전담율');" class="btn_02 download">엑셀다운로드</button>
            </div>
            <div class="char_area">
                <h1>전담차량 고객사별 사용실적</h1>
                <div class="grid_list">
                    <div id="CarPossessClientListGrid"></div>
                </div>
            </div>
        </div>
    </div>
