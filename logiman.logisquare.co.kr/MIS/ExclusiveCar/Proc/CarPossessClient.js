...
/***************************************************************************/
// 그리드
var GridID = "#CarPossessClientListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID) {
    ...
    objGridProps.rowIdField = ""; //다중 칼럼 필드 정렬(Sorting) 여부
    ...
    objGridProps.groupingFields = ["CenterName", "ClientName", "ConsignorName", "CenterCode", "ClientCode", "ConsignorCode"];
    ...
    objGridProps.groupingSummary = {
        ...
        excepts: ["CenterName", "ClientName", "CenterCode", "ClientCode", "ConsignorName"],
        labelTexts: ["", "", ""],
    ...
    objGridProps.cellMergeRowSpan = true
    objGridProps.cellMergePolicy = "withNull";
...
function fnCallGridData(strGID) {
    ...
    var objParam = {
        CallType: "StatCarDispatchClientList",
