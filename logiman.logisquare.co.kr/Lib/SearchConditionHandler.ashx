<%@ WebHandler Language="C#" Class="SearchConditionHandler" %>
...
public class SearchConditionHandler : AshxBaseHandler
{
    // 메소드 리스트
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("SearchConditionHandler",
                                "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("SearchConditionHandler");
        }
    }
    ...
    protected void SetSearchConditionUpd()
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("SearchConditionHandler", "Exception",
                "\r\n\t[ex.Message] : " + lo_ex.Message + "\r\n\t[ex.StackTrace] : " + lo_ex.StackTrace,
                objResMap.RetCode);
        }
    }
