	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
                sUrl: "/js/lib/SmartEditor2/Proc/SmartEditor2FileHandler.ashx?CallType=FileUpload",	//샘플 URL입니다.
                sCallback: location.href.replace(/\/[^\/]*$/, '') + '/smart_editor2_photo_callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
            ...
            error: function (oCustomEvent) {
                ...
                alert(decodeURI(oCustomEvent.htResult.errstr));
 	    	}
 	    });
 	}
