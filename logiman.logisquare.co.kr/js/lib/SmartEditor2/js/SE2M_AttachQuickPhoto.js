...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=0,top=0,width=500,height=300,scrollbars=no,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "./smart_editor2_photo.html";
