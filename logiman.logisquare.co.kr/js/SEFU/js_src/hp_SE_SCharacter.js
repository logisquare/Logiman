...
/*			if(this.bIE){
			...
			if(this.bIE){try{button=document.createElement("<BUTTON type='button'>");} catch(e){button=document.createElement("BUTTON");button.type="button";}} else{button=document.createElement("BUTTON");button.type="button";}
