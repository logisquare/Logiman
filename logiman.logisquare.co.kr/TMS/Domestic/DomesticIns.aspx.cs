...
{
    public partial class DomesticIns : PageBase
    {
        ...
        protected void GetInitData()
        {
            ...
            CommonDDLB.GOODS_DISPATCH_TYPE_DDLB(GoodsDispatchType);
            ...
            TransPayType.Items.Clear();
            TransPayType.Items.Add(new ListItem("비용구분", ""));
            TransPayType.Items.Add(new ListItem("매출", "1"));
            TransPayType.SelectedValue = TransPayType.Items.FindByText("매출") == null ? string.Empty : TransPayType.Items.FindByText("매출").Value;
            CommonDDLB.PAY_TAX_KIND_DDLB(TransTaxKind);
            TransTaxKind.SelectedValue = TransTaxKind.Items.FindByText("과세") == null ? string.Empty : TransTaxKind.Items.FindByText("과세").Value;
            CommonDDLB.ITEM_DDLB(Page, TransItemCode, "OP", objSes.AccessCenterCode, objSes.AdminID, "비용항목");
            TransItemCode.SelectedValue = TransItemCode.Items.FindByText("운임") == null ? string.Empty : TransItemCode.Items.FindByText("운임").Value;
