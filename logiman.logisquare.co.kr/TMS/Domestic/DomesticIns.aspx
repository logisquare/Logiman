<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="DomesticIns.aspx.cs" Inherits="TMS.Domestic.DomesticIns" %>
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script type="text/javascript" src="/TMS/Domestic/Proc/DomesticIns.js?ver=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
...
<%//자동운임 비교 항목 끝 %>
            ...
            <div class="popup_control">
                <div id="OrderFixed">
                    ...
                    <div style="margin-bottom:2px;"  runat="server" ID="DivButtons">
                        ...
                        <button type="button" class="btn_01" id="BtnRegTrans" style="display: none;">오더이관</button>
                        <button type="button" class="btn_04 BtnCargopass" id="BtnRegCargopass">카고패스등록</button>
                        <button type="button" class="btn_04 BtnCargopass" id="BtnDetailCargopass" style="display: none;">카고패스등록상세</button>
                    </div>
                </div>
                <table class="popup_table order_table">
                    ...
                    <tr>
                        <th rowspan="3" class="bdbt">
                            ...
                            <p class="change_place change_place_img1" onclick="fnChangePlace(); return false;"><span class="change_txt_top">상</span><br><span class="change_txt_bottom">하</span></p>
                        </th>
                        <td class="TdPickup bdnbt">
                            ...
                            <asp:TextBox runat="server" CssClass="type_small find essential" ID="PickupPlaceChargeName" placeholder="* 담당자명"></asp:TextBox>
                    ...
                    <tr>
                        <td class="TdPickup bdnbt">
                            ...
                            <asp:TextBox runat="server" CssClass="type_03 essential" ID="PickupPlaceAddr" placeholder="주소" readonly Width="300"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="TdGet bdnbt">
                            ...
                            <asp:TextBox runat="server" CssClass="type_small find essential" ID="GetPlaceChargeName" placeholder="* 담당자명"></asp:TextBox>
                    ...
                    <tr>
                        <td class="TdGet bdnbt">
                            ...
                            <asp:TextBox runat="server" CssClass="type_03 essential" ID="GetPlaceAddr" placeholder="주소" readonly Width="300"></asp:TextBox>
                    ...
                    <tr class="TrDispatch">
                        <th class = "bdbt">
                            ...
                            <button type="button" class="btn_04 DispatchType2" id="BtnOpenCarManage">관리차량</button>
                            <%} %>
                        ...
                        <td class="bdbt">
                            ...
                            <table class="popup_table tbcar">
                                ...
                                <tbody id="TBodyDispatch3" class="DispatchType3" style="display: none;">
                                </tbody>
                            </table>
                        </td>
                    </tr>
                    <tr class="TrTransRate DispatchType2">
                        <th class="bdbt">
                            자동운임<br/>
                            <button type="button" class="btn_02" id="BtnCallTransRate">확인</button><br/>
                            <button type="button" class="btn_01" id="BtnUpdRequestAmt" style="display: none;">수정요청</button>
                        </th>
                        <td class="bdbt">
                            <div class="NotAllowed NotAllowedTrans"></div>
                            <div class="NotAllowed NotAllowedContractTarget"></div>
                            ...
                            <table class="popup_table tbcar">
                                ...
                                <tr>
                                    <th>경유지</th>
                                    <th>매출</th>
                                    <td><asp:TextBox runat="server" ID="LayoverSaleUnitAmt" CssClass="type_01 ali_r" readonly></asp:TextBox></td>
                                    <th>매입 (고정)</th>
                                    <td><asp:TextBox runat="server" ID="LayoverFixedPurchaseUnitAmt" CssClass="type_01 ali_r" readonly></asp:TextBox></td>
                                    <th>매입 (용차)</th>
                                    <td><asp:TextBox runat="server" ID="LayoverPurchaseUnitAmt" CssClass="type_01 ali_r" readonly></asp:TextBox></td>
                                    <td>적용 : <span id="SpanLayoverTransRateInfo"></span></td>
                                </tr>
                                <tr>
                                    <th>유가연동</th>
                                    <th>매출</th>
                                    <td><asp:TextBox runat="server" ID="OilSaleUnitAmt" CssClass="type_01 ali_r" readonly></asp:TextBox></td>
                                    <th>매입 (고정)</th>
                                    <td><asp:TextBox runat="server" ID="OilFixedPurchaseUnitAmt" CssClass="type_01 ali_r" readonly></asp:TextBox></td>
                                    <th>매입 (용차)</th>
                                    <td><asp:TextBox runat="server" ID="OilPurchaseUnitAmt" CssClass="type_01 ali_r" readonly></asp:TextBox></td>
                                    <td>적용 : <span id="SpanOilTransRateInfo"></span></td>
                                </tr>
                            </table>
                    ...
                    <tr class="TrTransPay" style="display: none;">
                        <th rowspan="2">이관매출정보</th>
                        <td>
                            <asp:HiddenField runat="server" ID="TransSeqNo"/>
                            <asp:HiddenField runat="server" ID="TransPaySeqNo"/>
                            <asp:DropDownList runat="server" CssClass="type_01" ID="TransPayType" Width="80"></asp:DropDownList>
                            <asp:DropDownList runat="server" CssClass="type_01" ID="TransTaxKind" Width="80"></asp:DropDownList>
                            <asp:DropDownList runat="server" CssClass="type_01" ID="TransItemCode" Width="80"></asp:DropDownList>
                            <asp:TextBox runat="server" ID="TransSupplyAmt" CssClass="type_small Money" placeholder="* 공급가액" MaxLength="11"></asp:TextBox>
                            <asp:TextBox runat="server" ID="TransTaxAmt" CssClass="type_small Money" placeholder="부가세" MaxLength="10"></asp:TextBox>
                            <span style="float: right;">
                                <button type="button" class="btn_01" id="BtnTransAddPay">추가</button>
                                <button type="button" class="btn_02" id="BtnTransUpdPay" style="display: none;">수정</button>
                                <button type="button" class="btn_03" id="BtnTransDelPay" style="display: none;">삭제</button>
                                <button type="button" class="btn_02" id="BtnTransResetPay">다시입력</button>
                            </span>
                        </td>
                    </tr>
                    <tr class="TrTransPay" style="display: none;">
                        <td>
                            <div class="grid_list" style="margin-top: 0px;">
                                <div id="DomesticTransPayListGrid" class="subGridWrap"></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
    ...
    <div id="DivCarManage">
        <div>
            <a href="#" onclick="fnCloseCarManage(); return false;" class="close_btn">x</a>
            <div>
                <h1>관리 차량 배차</h1>
                <p>관리차량에서 현재 오더에 배차 등록한 차량입니다.</p>
                <div style="padding:10px;">
                    <div id="OrderCarManageList">
                        <table>
                            <colgroup>
                                <col style="width:87%"/> 
                                <col style="width:13%"/> 
            ...
            <div>
                <h1>연계 및 공유차량 배차</h1>
                <p>등록한 오더 상차지 기준 반경 30Km 이내에 하차 예정인 차량으로 실제 차량의 위치가 다를 수 있어 <span>해당 차주님과 확인 후 배차</span>가 필요합니다.</p>
                <div style="padding:10px;">
                    <div id="OrderCarShareListGrid"></div>
                </div>
            </div>
            <hr />
