<%@ WebHandler Language="C#" Class="DomesticFileHandler" %>
...
///================================================================
/// <summary>
/// FileName        : DomesticFileHandler.ashx
...
/// Author          : sybyun96@logislab.com, 2022-08-12
/// Modify History  : Just Created.
/// </summary>
///================================================================
public class DomesticFileHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/TMS/Domestic/DomesticIns"; //필수
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("DomesticFileHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("DomesticFileHandler");
        }
    }
