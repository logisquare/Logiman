window.name = "DomesticPayItemListGrid";
// 그리드
var GridID = "#DomesticPayItemListGrid";
var GridSort = [];
...
function fnGridInit() {
    // 그리드 레이아웃 생성
    fnCreateGridLayout(GridID, "PaySeqNo");
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'DomesticPayItemListGrid');
        return;
    });
};
...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/TMS/Domestic/Proc/DomesticPayItemHandler.ashx";
