<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DomesticPayItemList.aspx.cs" Inherits="TMS.Domestic.DomesticPayItemList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Domestic/Proc/DomesticPayItemList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contents">
        ...
        <div class="grid_list">
                        ...
                        <li>
							<dl>
								...
								<dd>
									...
									<asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('DomesticPayItemListGrid');">항목관리</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('DomesticPayItemListGrid');">항목순서 초기화</asp:LinkButton>
								</dd>
							</dl>
						</li>
					</ul>
            ...
            <div id="DomesticPayItemListGrid"></div>
			<div id="page"></div>
            <!-- 검색 다이얼로그 UI -->
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('DomesticPayItemListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('DomesticPayItemListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('DomesticPayItemListGrid');">취소</button>
            </div>
        </div>
    </div>
</asp:Content>
