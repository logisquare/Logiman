<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsignorList.aspx.cs" Inherits="TMS.Client.ConsignorList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Client/Proc/ConsignorList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#BtnSaveExcel").on("click", function () {
                var objParam = {
                    CallType: "ConsignorListExcel",
                    UseFlag: $("#UseFlag").val(),
                    CenterCode: $("#CenterCode").val(),
                    ConsignorName: $("#ConsignorName").val(),
                    ConsignorCeoName: $("#ConsignorCeoName").val()
                };
                
                $.fileDownload("/TMS/Client/Proc/ConsignorHandler.ashx", {
                    httpMethod: "POST",
                    data: objParam,
        ...
        function fnConsignorIns() {
            fnOpenRightSubLayer("화주 등록", "/TMS/Client/ConsignorIns", "500px", "700px", "50%");
        }
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contents">
        <div class="data_list">
            ...
            <ul class="action">
                ...
                <li class="right">
                    <button type="button" runat="server" class="btn_01" onclick="fnConsignorIns();">화주 등록</button>
                </li>
            </ul>
        </div>
        <div class="grid_list">
                    ...
                    <ul class="drop_btn" style="float:right;">
						<li>
							<dl>
								<dt>항목 설정</dt>
								<dd>
									<asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('ConsignorListGrid');">항목관리</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('ConsignorListGrid');">항목순서 초기화</asp:LinkButton>
								</dd>
							</dl>
						</li>
					</ul>
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('ConsignorListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('ConsignorListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('ConsignorListGrid');">취소</button>
            </div>
        </div>
    </div>
</asp:Content>
