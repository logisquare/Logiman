...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'ClientListGrid');
        return;
    });
};
...
function fnGridCellDblClick(event) {
    ...
    fnClientUpd(objItem.ClientCode);
}
...
function fnCallGridData(strGID) {
    ...
    var objParam = {
        ...
        SaleLimitAmtFlag: $("#SaleLimitAmtFlag").val(),
        RevenueLimitPerFlag: $("#RevenueLimitPerFlag").val(),
        PageNo: $("#PageNo").val(),
