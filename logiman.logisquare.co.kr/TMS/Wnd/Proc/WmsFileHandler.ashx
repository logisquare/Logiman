<%@ WebHandler Language="C#" Class="WmsFileHandler" %>
...
///================================================================
/// <summary>
/// FileName        : WmsFileHandler.ashx
/// Description     : 배송 오더 파일 Process Handler
/// Special Logic
///   - Use Session Variables : NONE
///   - Use Server Component  : NONE
///
/// Copyright ⓒ 2018 by LOGISLAB Inc. All rights reserved.
/// Author          : sybyun96@logislab.com, 2025-06-23
/// Modify History  : Just Created.
/// </summary>
///================================================================
public class WmsFileHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/TMS/Wnd/WmsIns"; //필수
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("WmsFileHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("WmsFileHandler");
        }
    }
