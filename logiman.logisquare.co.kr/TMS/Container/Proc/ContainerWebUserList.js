window.name = "ContainerWebUserListGrid";
// 그리드
var GridID = "#ContainerWebUserListGrid";
var GridSort = [];
...
function fnGridInit() {
    // 그리드 레이아웃 생성
    fnCreateGridLayout(GridID, "CarNo");
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'ContainerWebUserListGrid');
        return;
    });
};
...
function fnCallGridData(strGID) {
    ...
    /*var strHandlerURL = "/TMS/Car/Proc/CalHandler.ashx";
