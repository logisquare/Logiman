window.name = "ContainerPayItemListGrid";
// 그리드
var GridID = "#ContainerPayItemListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'ContainerPayItemListGrid');
        return;
    });
};
...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/TMS/Container/Proc/ContainerPayItemHandler.ashx";
