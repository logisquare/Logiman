<%@ WebHandler Language="C#" Class="ContainerPayItemHandler" %>
...
///================================================================
/// <summary>
/// FileName        : ContainerPayItemHandler.ashx
...
/// Author          : sybyun96@logislab.com, 2025-04-09
/// Modify History  : Just Created.
/// </summary>
///================================================================
public class ContainerPayItemHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/TMS/Container/ContainerPayItemList"; //필수

    // 메소드 리스트
    private const string MethodContainerPayItemList = "ContainerPayItemList"; //컨테이너 비용항목내역서
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        objMethodAuthList.Add(MethodContainerPayItemList, MenuAuthType.ReadOnly);
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("ContainerPayItemHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("ContainerPayItemHandler");
        }
    }
    ...
    private void Process()
    {
        try
        {
            switch (strCallType)
            {
                case MethodContainerPayItemList:
                    GetContainerPayItemList();
                    break;
                default:
    ...
    /// 수출입 비용항목리스트
    /// </summary>
    protected void GetContainerPayItemList()
    {
