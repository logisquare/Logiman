...
{
    public partial class PurchaseClientList : PageBase
    {
        ...
        protected void GetInitData()
        {
            ...
            string strClientCorpNo = Utils.IsNull(SiteGlobal.GetRequestForm("ClientCorpNo"), "");

            if (!string.IsNullOrWhiteSpace(strClientCorpNo))
            {
                ClientCorpNo.Text = strClientCorpNo;
            }
        }
    }
}