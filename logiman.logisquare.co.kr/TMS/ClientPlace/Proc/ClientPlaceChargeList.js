// 그리드
var GridID = "#ClientPlaceListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'ClientPlaceListGrid');
        return;
    });
};
...
function fnUpdClientPlaceCharge(PlaceSeqNo) {
    fnOpenRightSubLayer("상하차지 수정", "/TMS/ClientPlace/ClientPlaceChargeIns?HidMode=Update&PlaceSeqNo=" + PlaceSeqNo, "1024px", "700px", "80%");
    return;
}
