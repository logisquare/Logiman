// 그리드
var GridID = "#CarDispatchCooperatorListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    objGridProps.rowIdField = ""; // 키 필드 지정
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'CarDispatchCooperatorListGrid');
        return;
    });
};
...
function fnGridCellDblClick(event) {
    ...
    fnCarDispatchRefList(objItem.ComCorpNo, objItem.CenterCode);
}
...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/TMS/Car/Proc/CarDispatchRefListHandler.ashx";
    var strCallBackFunc = "fnGridSuccResult";

    var objParam = {
        CallType: "CarDispatchCooperatorList",
...
function fnCarDispatchRefList(strComCorpNo, strCenterCode) {
    parent.$("#ComCorpNo").val(strComCorpNo);
    parent.$("#CenterCode").val(strCenterCode);
    parent.$("#CooperatorFlag").prop("checked", true);
