// 그리드
var GridID = "#CarDispatchListGrid";
var GridSort = [];
...
function fnGridInit() {
    // 그리드 레이아웃 생성
    fnCreateGridLayout(GridID, "RefSeqNo");
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'CarDispatchListGrid');
        return;
    });
};
...
function fnGridCellDblClick(event) {
    ...
    fnUpdCarDispatch(objItem.RefSeqNo);
}
...
function fnUpdCarDispatch(RefSeqNo) {
    fnOpenRightSubLayer("차량업체 통합등록", "/TMS/Car/CarDispatchRefins?HidMode=Update&RefSeqNo=" + RefSeqNo, "1024px", "700px", "80%");
}
