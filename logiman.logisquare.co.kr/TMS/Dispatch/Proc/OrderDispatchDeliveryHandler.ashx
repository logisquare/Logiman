<%@ WebHandler Language="C#" Class="OrderDispatchDeliveryHandler" %>
...
///================================================================
/// <summary>
/// FileName        : OrderDispatchDeliveryHandler.ashx
/// Description     : 배송배차현황 Process Handler
/// Special Logic
...
/// </summary>
///================================================================
public class OrderDispatchDeliveryHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/TMS/Dispatch/OrderDispatchDeliveryList"; //필수
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("OrderDispatchDeliveryHandler");
        }
    }
