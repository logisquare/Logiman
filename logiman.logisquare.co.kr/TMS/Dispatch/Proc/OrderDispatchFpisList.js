// 그리드
var GridID = "#OrderDispatchFpisListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    objGridProps.selectionMode = "singleRow"; // 셀 선택 모드
    ...
    objGridProps.enableMultipleSorting = true;
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'OrderDispatchFpisListGrid');
        return;
    });
};
    ...
    var objColumnLayout = [
        ...
        /*************/
        {
            ...
            children: [{
                ...
                dataField: "TransPickupYMD",
                headerText: "운송완료년월",
                width: 100,
                dataType: "date",
                formatString: "yyyy-mm",
                labelFunction: function (rowIndex, columnIndex, value, headerText, item) {
                    return item.PickupYMD;
                }
            }, {
...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/TMS/Dispatch/Proc/OrderDispatchFpisHandler.ashx";
    var strCallBackFunc = "fnGridSuccResult";

    var objParam = {
        CallType: "OrderFpisList",
