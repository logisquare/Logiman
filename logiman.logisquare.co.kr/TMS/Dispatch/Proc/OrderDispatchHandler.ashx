<%@ WebHandler Language="C#" Class="OrderDispatchHandler" %>
...
///================================================================
/// <summary>
/// FileName        : OrderDispatchHandler.ashx
...
/// </summary>
///================================================================
public class OrderDispatchHandler : AshxBaseHandler
{
    //상수 선언
    ...
    private const string MethodOrderDispatchContractIns  = "OrderDispatchContractIns";     //위탁등록
    ...
    private const string MethodOrderLocationCodeUpd      = "OrderLocationCodeUpd";         //사업장 수정
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        objMethodAuthList.Add(MethodOrderDispatchContractIns,  MenuAuthType.ReadWrite);
        objMethodAuthList.Add(MethodContractCenterList,        MenuAuthType.ReadOnly);
        objMethodAuthList.Add(MethodOrderDispatchTypeUpd,      MenuAuthType.ReadWrite);
        objMethodAuthList.Add(MethodOrderLocationCodeUpd,      MenuAuthType.ReadWrite);
        objMethodAuthList.Add(MethodOrderDispatchCarList,      MenuAuthType.ReadOnly);
        objMethodAuthList.Add(MethodOrderDispatchCarStatusUpd, MenuAuthType.ReadWrite);
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("OrderDispatchHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("OrderDispatchHandler");
        }
    }
        ...
        try
        {
            ...
            {                
                ...
                case MethodOrderDispatchListExcel:
                    ...
                    break;                
                case MethodOrderDispatchContractIns:
                    SetOrderDispatchContractIns();
                    break;                
                ...
                case MethodOrderDispatchTypeUpd:
                    ...
                    break;
                case MethodOrderLocationCodeUpd:
                    SetOrderLocationCodeUpd();
                    break;
        ...
        try
        {
            ...
            foreach (var row in lo_objResOrderList.data.list)
            {
                ...
                lo_dtData.Rows.Add(row.CenterName,row.OrderStatusM,row.OrderNo,row.TransInfo,row.OrderItemCodeM
                                ...
                                ,row.DriverName4,row.DriverCell4,row.SaleSupplyAmt,row.PurchaseSupplyAmt,lo_intRevenue
                                ,lo_intRevenuePer,row.AdvanceSupplyAmt3,row.AdvanceSupplyAmt4,row.AcceptDate,row.AcceptAdminName
                                ,row.UpdDate,row.UpdAdminName);
            }
    ...
    protected void SetOrderDispatchContractIns()
    {
        ...
        try
        {
            ...
            lo_objResOrderDispatchModel = objOrderDispatchDasServices.InsContractMultiReq(lo_objReqOrderDispatchModel);
            ...
            objResMap.Add("TotalCnt", lo_objResOrderDispatchModel.data.TotalCnt);
            objResMap.Add("SuccCnt",  lo_objResOrderDispatchModel.data.SuccCnt);
            objResMap.Add("FailCnt",  lo_objResOrderDispatchModel.data.FailCnt);
        }
        catch (Exception lo_ex)
        {
            objResMap.RetCode = 9707;
            objResMap.ErrMsg  = CommonConstant.COMMON_EXCEPTION_MESSAGE;
    ...
    //사업장 업데이트
    protected void SetOrderLocationCodeUpd()
    {
        ...
        try
        {
            lo_objResOrderLocationUpd = objOrderDasServices.SetOrderLocationUpd(strOrderNos, strCenterCode.ToInt(), strLocationCode, objSes.AdminID, objSes.AdminName);
