<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderDispatchCollectList.aspx.cs" Inherits="TMS.Dispatch.OrderDispatchCollectList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Dispatch/Proc/OrderDispatchCollectList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField runat="server" ID="HiddenCenterCode" />
    ...
    <div id="contents">
        <div class="data_list">
            <div class="search">
                <div class="search_line">
                    ...
                    <asp:TextBox runat="server" ID="CarNo2" class="type_01" AutoPostBack="false" placeholder="집하 차량번호"/>
                    <asp:TextBox runat="server" ID="CarNo3" class="type_01" AutoPostBack="false" placeholder="간선 차량번호"/>
            ...
            <ul class="action">
                <li class="left">
                    ...
                    &nbsp;
                    <asp:RadioButton runat="server" ID="DispatchType2" GroupName="DispatchType" Text="<span></span> 집하" value="2"></asp:RadioButton>
                    &nbsp;
                    <asp:RadioButton runat="server" ID="DispatchType3" GroupName="DispatchType" Text="<span></span> 간선" value="3"></asp:RadioButton>
                    ...
                    &nbsp;
                    <button type="button" runat="server" class="btn_01" onclick="fnOrderDispatchInsConfirm();">배차</button>
                ...
                <li class="right">
                    <button type="button" runat="server" ID="BtnOpenRegCargopass2" onclick="fnOpenRegCargopass(2);" class="btn_01">집하카고패스등록</button>
                    <button type="button" runat="server" ID="BtnOpenRegCargopass3" onclick="fnOpenRegCargopass(3);" class="btn_01">간선카고패스등록</button>
                    &nbsp;&nbsp;
        ...
        <div class="grid_list">
            <ul class="grid_option">
                <li class="left">
                    <button type="button" runat="server" class="btn_01" onclick="fnDirectUpdConfirm();">직송변경</button>
                    &nbsp;
                    <asp:DropDownList runat="server" ID="LocationCode" CssClass="type_01"></asp:DropDownList>
                    <button type="button" runat="server" class="btn_01" onclick="fnDispatchCollectConfirm();">배송요청</button>
                </li>
                <li class="right">
                    ...
                    <ul class="drop_btn" style="float:right;">
						<li>
							<dl>
								<dt>항목 설정</dt>
								<dd>
									<asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('OrderDispatchCollectListGrid');">항목관리</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('OrderDispatchCollectListGrid');">항목순서 초기화</asp:LinkButton>
								</dd>
							</dl>
						</li>
					</ul>
            ...
            <div class="grid_type_03">
                <div class="left">
                    <div id="OrderDispatchCollectListGrid"></div>
                    <div id="page"></div>
                </div>
                <div class="right">
                    <button type="button" class="grid_btn" onclick="fnGridToggle();"></button>
                    <div class="search">
                        <div class="search_line">
                            <asp:RadioButton runat="server" ID="DispatchTypeRadio1" GroupName="DispatchTypeRadio" Checked="true" Text=" 집하적재" value="2"/>
                            <asp:RadioButton runat="server" ID="DispatchTypeRadio2" GroupName="DispatchTypeRadio" Text=" 간선적재" value="3"/>
                            <asp:TextBox runat="server" CssClass="type_small OnlyNumber" ID="PurchaseSupplyAmt" placeholder="비용입력"></asp:TextBox>
                            <button type="button" class="btn_01" onclick="fnCollectPayConfirm(1);">등록</button>
                            <button type="button" class="btn_03" onclick="fnCollectPayConfirm(2);">삭제</button>
                        </div>
                    </div>
                    <div id="OrderDispatchCollectCostGrid"></div>
                </div>
            </div>
        </div>
	</div>
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('OrderDispatchCollectListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('OrderDispatchCollectListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('OrderDispatchCollectListGrid');">취소</button>
            </div>
        </div>
    </div>
