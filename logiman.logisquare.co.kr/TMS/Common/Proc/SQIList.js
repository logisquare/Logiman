window.name = "SQIListGrid";
// 그리드
var GridID = "#SQIListGrid";
var GridSort = [];
...
function fnGridInit() {
    // 그리드 레이아웃 생성
    fnCreateGridLayout(GridID, "SQISeqNo");
...
function fnGridCellDblClick(event) {
    ...
    fnSQIView(objItem.OrderNo, objItem.CenterCode, objItem.SQISeqNo);
}
...
function fnSQIView(strOrderNo, strCenterCode, strSQISeqNo) {
    strOrderNo = (typeof strOrderNo === "undefined" || strOrderNo === null) ? "" : strOrderNo;
    strCenterCode = (typeof strCenterCode === "undefined" || strCenterCode === null) ? "" : strCenterCode;
    strSQISeqNo = (typeof strSQISeqNo === "undefined" || strSQISeqNo === null) ? "" : strSQISeqNo;
    var strOrderType = $("#OrderType").val();

    window.open("/TMS/Common/SQIDetailView?OrderType=" + strOrderType + "&CenterCode=" + strCenterCode + "&OrderNo=" + strOrderNo + "&SQISeqNo=" + strSQISeqNo, "오더SQI목록", "width=760, height=850, scrollbars=Yes");
    return;
}
