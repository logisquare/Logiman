    ...
    if (ObjRes[0].data.list.length > 0) {
        ...
        for (var f = 0; f < uniqueArrIndex.length; f++) {
            ...
            if (f === 0) {
                ...
                strTb += "</ul>";
                strTb += "<h1>운송내역서(기간)_(" + fnGetStrDateFormat(ObjRes[0].data.list[0].PickupYMD, ".") + " ~ " + fnGetStrDateFormat(ObjRes[0].data.list[ObjRes[0].data.RecordCnt - 1].PickupYMD, ".") + ")</h1>";
                ...
                strTb += "<tr>";
                strTb += "<th>총청구금액</th>";
                strTb += "<td colspan='2'>" + fnMoneyComma(TotalSupplyAmt + TotalTaxAmt) + "</td>";
                strTb += "</tr>";
                strTb += "</tbody>";
                strTb += "</table>";
                //상세내역
                ...
                if (i === uniqueArrIndex[f]) {
                    ...
                    for (var y = 0; y < ObjRes[0].data.list.length; y++) {
                        if (ObjRes[0].data.list[y].OrderNo === uniqueArr[f]) {
                            //운임
                            if (ObjRes[0].data.list[y].ItemCode === "OP001") {
                    ...
                    strTb += "<td>" + (ObjRes[0].data.list[i].CntrNo == null || ObjRes[0].data.list[i].CntrNo == "" ? "" : ObjRes[0].data.list[i].CntrNo) + "</td>";
                    strTb += "<td>" + (ObjRes[0].data.list[i].SealNo == null || ObjRes[0].data.list[i].SealNo == "" ? "" : ObjRes[0].data.list[i].SealNo) + "</td>";
                    strTb += "<td>" + (ObjRes[0].data.list[i].PickupPlaceLocalName == null || ObjRes[0].data.list[i].PickupPlaceLocalName == "" ? "" : ObjRes[0].data.list[i].PickupPlaceLocalName) + "</td>";
                    strTb += "<td>" + (ObjRes[0].data.list[i].BookingNo == null || ObjRes[0].data.list[i].BookingNo == "" ? "" : ObjRes[0].data.list[i].BookingNo) + "</td>";
