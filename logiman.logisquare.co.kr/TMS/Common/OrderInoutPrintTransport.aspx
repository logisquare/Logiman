<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="OrderInoutPrintTransport.aspx.cs" Inherits="TMS.Common.OrderInoutPrintTransport" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Common/Proc/OrderInoutPrintTansList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <style>
        ...
        div.transport_print h2 {padding-top:30px; font-size:16px; font-weight:400; color:#333;}
        table.type_02 {width:100%; margin-top:15px; border-top:2px solid #000;}
        table.type_02 thead.amt th {text-align:center;}
        table.type_02 th {height:30px; border:1px solid #E1E6EA; background:#F4F6F8; text-align:left; padding:0 10px; color:#000}
        table.type_02 tbody.amt td {text-align:center;}
        table.type_02 td {height:30px; border:1px solid #E1E6EA; text-align:left; padding:0 10px; color:#000;}
        ...
        div.print_bottom {background:#F4F6F8; padding:10px 0; width:100%; margin-top:180px;}
