<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="OrderDomesticPrint.aspx.cs" Inherits="TMS.Common.OrderDomesticPrint" %>
<%@ Import Namespace="CommonLibrary.CommonModule" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Common/Proc/OrderDomesticPrintList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <style>
        * {margin: 0px; padding: 0px; font-family: "Noto Sans KR", sans-serif; box-sizing: border-box; font-weight: 400;}
        ...
        table.type_01 thead th {border:1px solid #E1E6EA; height:30px; color:#000; background:#F4F6F8;}
        ...
        table.type_02 {width:100%; margin-top:5px; border-top:2px solid #000; margin-left:0px;}
        table.type_02 thead {display: table-header-group  }
        table.type_02 thead.tleft td {text-align:left;}
        table.type_02 tr {page-break-inside: avoid !important;}
        table.type_02 td {page-break-inside: avoid !important;}
        table.type_02 thead th {text-align:center; }
        table.type_02 th {font-size:12px; height:30px; border:1px solid #E1E6EA; background:#F4F6F8; text-align:left; padding:0 2px; color:#333333; text-align:center; word-break: keep-all;}
        table.type_02 tbody.amt td {text-align:right;}
        table.type_02 td {height:30px; border:1px solid #E1E6EA; text-align:left; padding:0 10px; color:#000; text-align:center; font-size:12px;}
        ...
        div.print_bottom dl dd {color:#000; text-align:center; padding-bottom:15px;}
        ...
        div.btnArea{width:100%; height:120px; margin:5px 0; padding:0px; text-align:right; border-bottom:2px dashed #aaa; }
        @media print {
            @page {
                size: A4;
                margin: 5mm;
    ...
    <div class="btnArea" runat="server" id="BtnArea">
	    <div class="btn">
            ...
            <ul class="print_btn_type02">
                ...
                <li><button type="button" class="btn_01" onclick="window.print(); return false;">인쇄</button>&nbsp;
