<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="OrderContainerPrintClient.aspx.cs" Inherits="TMS.Common.OrderContainerPrintClient" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Common/Proc/OrderContainerPrintClientList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <style>
        ...
        table.type_02 th {font-size:14px; height:30px; border:1px solid #E1E6EA; background:#F4F6F8; text-align:center; padding:0 2px; color:#333333; word-break: keep-all;}
        table.type_02 tbody.amt td {text-align:right;}
        table.type_02 td {height:30px; border:1px solid #E1E6EA; text-align:left; padding:0 10px; color:#707070; font-size:12px; word-break: keep-all;}
        ...
        div.print_area p.charge_info {padding-top:30px; font-size:12px; color:#333333; text-align:center;}
