<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="OrderInoutPrintClient.aspx.cs" Inherits="TMS.Common.OrderInoutPrintClient" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Common/Proc/OrderInoutPrintClientList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <style>
        div.page_line {width: 100%; position: relative; margin: 0px; padding: 0px;}
        div.print_area ul.top_ul {font-size:12px; overflow:hidden; width:100%; padding-top: 40px; margin-top: 40px; border-top: 1px dashed #000;}
        div.print_area ul.top_ul.first {padding-top: 0px; margin-top: 40px; border-top: none;}
        ...
        table.type_02 {width:100%; margin-top:5px; border-top:2px solid #000;}
        table.type_02 thead th {text-align:center; }
        table.type_02 th {font-size:14px; height:30px; border:1px solid #E1E6EA; background:#F4F6F8; text-align:center; padding:0 2px; color:#000; word-break: keep-all;}
        table.type_02 tbody.amt td {text-align:right;}
        table.type_02 td {height:30px; border:1px solid #E1E6EA; text-align:left; padding:0 10px; color:#000; font-size:14px; word-break: keep-all;}
        ...
        div.print_area p.charge_info {padding-top:30px; font-size:12px; color:#000; text-align:center;}
        ...
        @media print {
            ...
            div.print_area ul.top_ul.first  {margin-top:0px;}
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField runat="server" ID="MailTitle" />
    
    <div class="btnArea" id="BtnArea" runat="server">
	    <div class="btn">
