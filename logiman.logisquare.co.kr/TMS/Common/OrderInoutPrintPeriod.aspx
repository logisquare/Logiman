<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="OrderInoutPrintPeriod.aspx.cs" Inherits="TMS.Common.OrderInoutPrintPeriod" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Common/Proc/OrderInoutPrintPeriodList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <style>
        ...
        table.type_01 {width:100%; margin-top:15px; margin-left:0px;}
        table.type_01 thead th {border:1px solid #E1E6EA; height:30px; color:#000; background:#F4F6F8;}
        table.type_01 tbody td {border:1px solid #E1E6EA; height:30px; text-align:center; padding:0 10px; color:#000}
        ...
        table.type_02 th {font-size:12px; height:30px; border:1px solid #E1E6EA; background:#F4F6F8; text-align:left; padding:0 2px; color:#000; text-align:center; word-break: keep-all;}
        table.type_02 tbody.amt td {text-align:right;}
        table.type_02 td {height:30px; border:1px solid #E1E6EA; text-align:left; padding:0 5px; color:#000; text-align:center; font-size:12px; word-break:break-all;}
        table.type_02 tr.pd0 td {padding:0px;}
