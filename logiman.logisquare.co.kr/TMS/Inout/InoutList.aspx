<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InoutList.aspx.cs" Inherits="TMS.Inout.InoutList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Inout/Proc/InoutList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#BtnSaveExcel").on("click", function () {
                ...
                $.fileDownload("/TMS/Inout/Proc/InoutHandler.ashx", {
                    httpMethod: "POST",
                    data: objParam,
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="data_list">
            ...
            <ul class="action">
                <li class="left">
                    ...
                    &nbsp;
                    <button type="button" class="btn_02" id="BtnWebUpdRequest"  onclick="fnWebOrderChg();">웹수정요청</button>
                    &nbsp;
                    ...
                    <ul class="drop_down_btn">
                        <li>
                            <dl>
                                <dt>발송</dt>
                                <dd>
                                    <asp:LinkButton runat="server" title="SMS" href="javascript:fnMsgSend(2);">SMS</asp:LinkButton>
                                    <asp:LinkButton runat="server" title="표준화물위탁증(SMS)" href="javascript:alert('준비중입니다.');">표준화물위탁증(SMS)</asp:LinkButton>
                    ...
                    <ul class="drop_btn">
                        <li>
							<dl>
								<dt>항목 설정</dt>
								<dd>
                                    <asp:LinkButton runat="server" title="엑셀다운로드" href="javascript:fnGridExportAs(GridID, 'xlsx', '수출입오더내역', '수출입오더내역');">엑셀다운로드</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('InoutListGrid');">항목관리</asp:LinkButton>
                                    <asp:LinkButton runat="server" title="항목순서 저장" href="javascript:fnSaveColumnCustomLayout('InoutListGrid');">항목순서 저장</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('InoutListGrid');">항목순서 초기화</asp:LinkButton>
								</dd>
							</dl>
						</li>
					</ul>
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('InoutListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('InoutListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('InoutListGrid');">취소</button>
            </div>
        </div>
    </div>
