<%@ WebHandler Language="C#" Class="InoutPayItemHandler" %>
...
///================================================================
/// <summary>
/// FileName        : InoutPayItemHandler.ashx
...
/// </summary>
///================================================================
public class InoutPayItemHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/TMS/Inout/InoutPayItemList"; //필수

    // 메소드 리스트
    private const string MethodInoutPayItemList      = "InoutPayItemList";      //수출입 비용항목내역서
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        objMethodAuthList.Add(MethodInoutPayItemList,      MenuAuthType.ReadOnly);
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("InoutPayItemHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("InoutPayItemHandler");
        }
    }
    ...
    /// 수출입 비용항목리스트
    /// </summary>
    protected void GetInoutPayItemList()
    {
