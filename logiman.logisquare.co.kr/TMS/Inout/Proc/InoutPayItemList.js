window.name = "InoutPayItemListGrid";
// 그리드
var GridID = "#InoutPayItemListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'InoutPayItemListGrid');
        return;
    });
};
...
function fnCallGridData(strGID) {
    ...
    var strHandlerURL = "/TMS/Inout/Proc/InoutPayItemHandler.ashx";
