<%@ WebHandler Language="C#" Class="InoutFileHandler" %>
...
///================================================================
/// <summary>
/// FileName        : InoutFileHandler.ashx
...
/// </summary>
///================================================================
public class InoutFileHandler : AshxBaseHandler
{
    //상수 선언
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("InoutFileHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("InoutFileHandler");
        }
    }
