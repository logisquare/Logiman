window.name = "InoutGMListGrid";
// 그리드
var GridID = "#InoutGMListGrid";
var GridSort = [];
...
function fnCreateGridLayout(strGID, strRowIdField) {
    ...
    AUIGrid.bind(GridID, "columnStateChange", function (event) {
        fnSaveColumnLayoutAuto(GridID, 'InoutGMListGrid');
        return;
    });
};
...
function fnGetDefaultColumnLayout() {
    var objColumnLayout = [
        ...
        {
            dataField: "PickupYMDHM",
            headerText: "PICK UP DATE",
            editable: false,
            width: 120,
            filter: { showIcon: true },
            viewstatus: false
...
function fnSetGridFooter(strGID) {
    ...
    var GridFooterObject = [
        ...
        },
        {
            ...
            positionField: "PTVolume",
            dataField: "PTVolume",
            operation: "SUM",
            formatString: "#,##0",
            style: "aui-grid-text-right"
        }, {
            positionField: "CTVolume",
            dataField: "CTVolume",
            operation: "SUM",
            formatString: "#,##0",
            style: "aui-grid-text-right"
...
function fnRegOrder() {
    var strTitle = "GM오더등록";
    var strUrl = "/TMS/Inout/InoutGMOrderIns";
    window.open(strUrl, strTitle, "width=1500, height=800px, scrollbars=Yes");
    return false;
}

//Location 코드관리
function fnRegLocationCode() {
    var strTitle = "GMLocation코드관리";
    var strUrl = "/TMS/Inout/InoutGMLocationIns";
    window.open(strUrl, strTitle, "width=1500, height=800px, scrollbars=Yes");
    return false;
}