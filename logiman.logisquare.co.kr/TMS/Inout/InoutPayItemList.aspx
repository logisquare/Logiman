<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InoutPayItemList.aspx.cs" Inherits="TMS.Inout.InoutPayItemList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Inout/Proc/InoutPayItemList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contents">
        <div class="data_list">
            <div class="search">
                ...
                <div class="search_line">
                    ...
                    <asp:DropDownList runat="server" ID="DispatchType" class="type_01" AutoPostBack="false"></asp:DropDownList>
        ...
        <div class="grid_list">
                        ...
                        <li>
							<dl>
								...
								<dd>
									...
									<asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('InoutPayItemListGrid');">항목관리</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('InoutPayItemListGrid');">항목순서 초기화</asp:LinkButton>
								</dd>
							</dl>
						</li>
					</ul>
            ...
            <div id="InoutPayItemListGrid"></div>
			<div id="page"></div>
            <!-- 검색 다이얼로그 UI -->
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('InoutPayItemListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('InoutPayItemListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('InoutPayItemListGrid');">취소</button>
            </div>
        </div>
    </div>
</asp:Content>
