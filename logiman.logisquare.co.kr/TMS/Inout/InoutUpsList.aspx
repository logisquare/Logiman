<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InoutUpsList.aspx.cs" Inherits="TMS.Inout.InoutUpsList" %>

<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Inout/Proc/InoutUpsList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contents">
        ...
        <div class="grid_list" style="margin-top: 0;">
            <ul class="grid_option">
                ...
                <li class="right">
                    <button type="button" class="btn_02 download" onclick="fnInoutUpsExcel();">UPS수출입내역서</button>
                    &nbsp;&nbsp;
                        ...
                        <li>
							<dl>
								...
								<dd>
									...
									<asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('InoutUpsListGrid');">항목관리</asp:LinkButton>
                                    <asp:LinkButton runat="server" title="항목순서 저장" href="javascript:fnSaveColumnCustomLayout('InoutUpsListGrid');">항목순서 저장</asp:LinkButton>
									<asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('InoutUpsListGrid');">항목순서 초기화</asp:LinkButton>
								</dd>
							</dl>
						</li>
					</ul>
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('InoutUpsListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('InoutUpsListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('InoutUpsListGrid');">취소</button>
            </div>
        </div>
    </div>
</asp:Content>
