<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CargopassList.aspx.cs" Inherits="TMS.Cargopass.CargopassList" %>
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    <script src="/TMS/Cargopass/Proc/CargopassList.js?var=<%=DateTime.Now.ToString("yyyyMMddHHmmss")%>"></script>
    ...
    <style>
        form { height: auto;}
        #contents { padding:20px !important;}
    </style>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <ul class="drop_btn" style="float:right;">
                            <li>
                                <dl>
                                    <dt>항목 설정</dt>
                                    <dd>
                                        <asp:LinkButton runat="server" title="엑셀다운로드" href="javascript:fnGridExportAs(GridID, 'xlsx', '카고패스등록현황', '카고패스등록현황');">엑셀다운로드</asp:LinkButton>
                                        <asp:LinkButton runat="server" title="항목관리" href="javascript:fnGridColumnManage('CargopassListGrid');">항목관리</asp:LinkButton>
                                        <asp:LinkButton runat="server" title="항목순서 저장" href="javascript:fnSaveColumnCustomLayout('CargopassListGrid');">항목순서 저장</asp:LinkButton>
                                        <asp:LinkButton runat="server" title="항목순서 초기화" href="javascript:fnResetColumnLayout('CargopassListGrid');">항목순서 초기화</asp:LinkButton>
                                    </dd>
                                </dl>
                            </li>
                        </ul>
    ...
    <div id="GRID_COLUMN_LAYER">
        <div class="grid_manage">
            <h1><input id="AllGridColumnCheck" type="checkbox" onclick="fnColumnChkAll('CargopassListGrid');" /><label for="AllGridColumnCheck"><span></span></label> 항목관리</h1>
            <div id="GridColumn"></div>
            <div class="gird_button">
                <button type="button" class="save" onclick="fnSaveColumnCustomLayout('CargopassListGrid');">저장</button>
                &nbsp;&nbsp;
                <button type="button" class="cancel" onclick="fnCloseColumnLayout('CargopassListGrid');">취소</button>
            </div>
        </div>
    </div>
