<%@ WebHandler Language="C#" Class="CargopassHandler" %>
...
///================================================================
/// <summary>
/// FileName        : CargopassHandler.ashx
...
/// </summary>
///================================================================
public class CargopassHandler : AshxBaseHandler
{
    //상수 선언
    private const string CurrentMenuLink = "/TMS/Cargopass/CargopassList"; //필수
    ...
    public override void ProcessRequest(HttpContext context)
    {
        ...
        catch (Exception lo_ex)
        {
            ...
            SiteGlobal.WriteLog("CargopassHandler", "Exception",
        ...
        {
            //3. 결과 출력 - 종료
            WriteJsonResponse("CargopassHandler");
        }
    }
    ...
    protected void GetCargopassDetail()
    {
        ...
        try
        {
            ...
            if (!lo_objResCargopassList.data.RecordCnt.Equals(1))
            {
                ...
                objResMap.ErrMsg  = "카고패스 등록정보가 없습니다.";
                return;
            }
            ...
            if (!lo_objResCargopassList.data.list[0].RegAdminID.Equals(objSes.AdminID))
            {
                ...
                objResMap.ErrMsg  = "카고패스 등록정보를 볼 수 있는 권한이 없습니다.";
                return;
            }
    ...
    protected void SetCargopassIns()
    {
        ...
        if (string.IsNullOrWhiteSpace(objSes.Network24DDID) && string.IsNullOrWhiteSpace(objSes.NetworkHMMID) && string.IsNullOrWhiteSpace(objSes.NetworkOneCallID) && string.IsNullOrWhiteSpace(objSes.NetworkOneCallID) && string.IsNullOrWhiteSpace(objSes.NetworkHmadangID))
        {
            ...
            objResMap.ErrMsg  = "내 정보 수정에서 정보망 아이디를 입력해야 카고패스 등록이 가능합니다.";
            return;
        }
